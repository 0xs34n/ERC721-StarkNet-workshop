...
const ERC721Response = await defaultProvider.deployContract({
  ...
  constructorCalldata: stark.compileCalldata({
    ...
    owner: "0x024d881b63aea2b9e034b3cc5632838e868bc3919bdec216fa4379b7f8a25310",
...
console.log(
  `https://testnet.starkscan.co/tx/${ERC721Response.transaction_hash}`
);

console.log(
  `https://testnet.starkscan.co/contract/${ERC721Response.contract_address}`
);
